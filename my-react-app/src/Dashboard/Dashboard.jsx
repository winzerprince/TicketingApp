    ...
    return (<>
        ...
        <main className={styles.dashboard}>
            <section className={styles.leftBarSection}>
                ...
                <a href="#"><img className={styles.icon} src={setup} alt="" /> Setup</a>

                <a href="#"><img className={styles.icon} src={home} alt="" /> Home</a>
                <a href="#"> <img className={styles.icon} src={pay} alt="" />Getting Paid</a>
                <a href="#"><img className={styles.icon} src={calender} alt="" /> Booking Calender</a>
                <a href="#"> <img className={styles.icon} src={event} alt="" />Events</a>
                <a href="#"><img className={styles.icon} src={sales} alt="" /> Sales</a>
                <a href="#"><img className={styles.icon} src={cataloge} alt="" /> Cataloge</a>
                <a href="#"><img className={styles.icon} src={blog} alt="" />Blog</a>
                <a href="#"><img className={styles.icon} src={libarary} alt="" />Video Library</a>
                <a href="#"><img className={styles.icon} src={apps} alt="" />Sites And Mobile App</a>
                <a href="#"><img className={styles.icon} src={inbox} alt="" />Inbox</a>
                <div><hr />
                    <a href="#"><img className={styles.icon} src={edit} alt="" />Edit Site</a>
                </div>
                <a href="http://"></a>
            </section>
